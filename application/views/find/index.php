...
Get the care you need.</strong></p>

<div class="ui form segment">
  <p>Let's go ahead and get you signed up.</p>
  <div class="field">
    <label><H3><STRONG>CHOOSE A SPECIALITY</STRONG></H3></label>
  ...
  <div class="field">
    <label><H3><STRONG>COUNTRY</STRONG></H3></label>
  ...
  <div class="field">
    <label><H3><STRONG>YOUR CITY</STRONG></H3></label>
    <div class="ui fluid search selection dropdown">
  <input type="hidden" name="country">
  <i class="dropdown icon"></i>
  ...
  <div class="field">
    <label><H3><STRONG>MEDICAL AID</STRONG></H3></label>
    <div class="ui dropdown selection">
      <input type="hidden" name="medicalaid">
      <div class="default text">SELECT YOUR MEDICAL AID</div>
      <i class="dropdown icon"></i>
      <div class="menu">
        ...
        <div class="item" data-value="TN HEALTH">TN HEALTH</div>
         <div class="item" data-value="PSMAS">PSMAS</div>
        <div class="item" data-value="OLD MUTUAL">OLD MUTUAL</div>
        <div class="item" data-value="Emf Medical Aid Society">Emf Medical Aid Society</div>
         <div class="item" data-value="Emf Medical Aid Society">Emf Medical Aid Society</div>
         <div class="item" data-value="Emf Medical Aid Society">Emf Medical Aid Society</div>
          <div class="item" data-value="CORPORATE 24">CORPORATE 24</div>
        <div class="item" data-value="TN HEALTH">TN HEALTH</div>
 ...
 <div class="ui attached bottom right aligned segment">
        <input type="submit" class="ui fluid primary huge button" value="Find your Doctor">
    </div>
