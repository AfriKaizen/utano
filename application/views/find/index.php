...
<div class="ui form segment">
  ...
  <div class="field">
    ...
    <div class="ui dropdown selection">
      ...
      <div class="default text">CHOOSE A SPECIALITY</div>
  ...
  <div class="field">
    <label><H3><STRONG>MEDICAL PRACTICTIONERS WHO TAKE</STRONG></H3></label>
    <div class="ui dropdown selection">
      ...
      <div class="menu">
        ...
        <input type="submit" class="ui fluid primary huge button" value="Find a Doctor">
